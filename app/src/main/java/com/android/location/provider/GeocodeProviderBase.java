 ...
 * {@link GeocodeProviderBase#getBinder()} in its getBinder() method.
 *
...
public abstract class GeocodeProviderBase {
	...
	private IGeocodeProvider.Stub mProvider = new IGeocodeProvider.Stub() {
		public String getFromLocation(double latitude, double longitude, int maxResults,
			...
			return GeocodeProviderBase.this.onGetFromLocation(latitude, longitude, maxResults,
														  params, addrs);
		}
		...
		public String getFromLocationName(String locationName,
                                          ...
                                          GeocoderParams params, List<Address> addrs) {
			return GeocodeProviderBase.this.onGetFromLocationName(locationName, lowerLeftLatitude,
